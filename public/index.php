...
//        $html->element('button', ['onclick' => 'doThingA()'], ['A']),
//        $html->element('button', ['onclick' => 'doThingB()'], ['B']),
    ]),
]);

$main = $html->element('main', [], [$article, $aside]);
...
$document = $doc->document(
    bodyContent: [$header, $main, $footer],
    options: [
...
$result = HTMLForge::strict(profile: ValidationProfile::STRICT_HTML)
    ->render($document);
